...
@XmlRootElement(name = "beginPaymentResponse")
/**
 * @author Anil.Thakur
 */
public class FccBeginPaymentResponse extends FccCommonPoiResponse implements FccNamed, Serializable
{
    ...
    {
        return FCCResponseTypeEnum.BeginPaymentResp.name();
    }
