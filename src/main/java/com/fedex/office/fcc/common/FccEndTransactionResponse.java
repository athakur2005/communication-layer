...
@XmlRootElement(name = "endTransResponse")
/**
 * @author Anil.Thakur
 */
public class FccEndTransactionResponse extends FccCommonPoiResponse
        implements FccNamed, Serializable
{
    ...
    {
        return FCCResponseTypeEnum.EndTransactionResp.name();
    }
