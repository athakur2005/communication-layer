...
@XmlRootElement(name = "endTransRequest")
/**
 * @author Anil.Thakur
 */
public class FccXmlEndTransactionRequest implements FccNamed, Serializable
{
    ...
    {
        return FCCRequestTypeEnum.EndTransactionRequest.name();
    }
