...
@XmlRootElement(name = "endPaymentResponse")
/**
 * @author Anil.Thakur
 */
public class FccEndPaymentResponse extends FccCommonPoiResponse implements FccNamed, Serializable
{
    ...
    {
        return FCCResponseTypeEnum.EndPaymentResp.name();
    }
