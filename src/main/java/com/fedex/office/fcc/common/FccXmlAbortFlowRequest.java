...
@XmlRootElement(name = "abortFlowRequest")
/**
 * @author Anil.Thakur
 */
public class FccXmlAbortFlowRequest implements FccNamed, Serializable
{
    ...
    {
        return FCCRequestTypeEnum.AbortFlowRequest.name();
    }
