...
@XmlRootElement(name = "formEntryResponse")
/**
 * @author Anil.Thakur
 */
public class FccFormEntryResponse extends FccCommonPoiResponse implements FccNamed, Serializable
{
    ...
    {
        return FCCResponseTypeEnum.FormEntryResp.name();
    }
