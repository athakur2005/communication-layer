 ...
 * @author Anil.Thakur
 */
public class FccPosRequestData extends FccCommonRequest implements FccNamed, Serializable
{
    ...
    @XmlElement(name = "CustomerPONumber", required = false)
    protected String customerPONumber;

    @XmlElement(name = "CustomerPODate", required = false)
    protected String customerPODate;

    @XmlElement(name = "CustomerCode", required = false)
    protected String customerCode;
    
    @XmlElement(name = "AllowPartial", required = false)
    protected String AllowPartial;

    public String getName()
    {
        return FCCRequestTypeEnum.Sale.name();
    }
    ...
    /**
     * @param customerPODate
     *            the customerPODate to set
     */
