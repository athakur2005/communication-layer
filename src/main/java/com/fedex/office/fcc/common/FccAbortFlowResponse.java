...
@XmlRootElement(name = "abortFlowResponse")
/**
 * @author Anil.Thakur
 */
public class FccAbortFlowResponse extends FccCommonPoiResponse implements FccNamed, Serializable
{
    ...
    {
        return FCCResponseTypeEnum.AbortFlowResp.name();
    }
