...
@XmlRootElement(name = "endPaymentRequest")
/**
 * @author Anil.Thakur
 */
public class FccXmlEndPaymentRequest implements FccNamed, Serializable
{
    ...
    {
        return FCCRequestTypeEnum.EndPaymentRequest.name();
    }
